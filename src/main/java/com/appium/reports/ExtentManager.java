...
public class ExtentManager {
	...
	public synchronized ExtentReports doGetReporter(String filePath) {
		...
		loadConfig();
		extent.addSystemInfo("Appium Java Client Version", "4.0.0").addSystemInfo("Appium Server Version", "1.5.3");
	...
	public synchronized void logFinalScreenshot(String imgSrc, String headerName) {
		imgSrc = "<div class='col l4 m6 s12'><div class='card-panel'><span class='panel-name'><h6 class='md-display-2'>"
				+ headerName + "</h6></span><img src='" + imgSrc + "' style=\"width:100%;height:100%;\"></div></div>";
		extent.setTestRunnerOutput(imgSrc);
	}

	public synchronized void logRunnerHeading(String reportHeader) {
		reportHeader = "<div class='col s12'><div class='card-panel'><span class='panel-name'><h5 class='md-display-2'>"
