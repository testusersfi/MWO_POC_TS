...
public class AppiumSingleTest {
	...
	public void androidSetup() throws MalformedURLException {
		...
		// driver = new AndroidDriver<MobileElement>(new URL(appium_URL),
		// capabilities);
	}
	...
	public static void startAppiumServer() throws InterruptedException {
		...
		service = AppiumDriverLocalService.buildService(new AppiumServiceBuilder().usingDriverExecutable(node)
				.withAppiumJS(appiumjs).withIPAddress(APPIUM_SERVER_ADDRESS).usingPort(4723).withLogFile(appiumlog));
