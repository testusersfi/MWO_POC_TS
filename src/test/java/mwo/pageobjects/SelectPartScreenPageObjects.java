...
public class SelectPartScreenPageObjects {

	@AndroidFindBy(xpath = "//android.widget.TextView[contains(@text,'Select a part')]")
	@iOSFindBy(xpath = "//UIASTATICTEXT[@text='Select a part'")
	public MobileElement SELECT_PART_SCREEN_HEADER;

	@AndroidFindBy(xpath = "//android.widget.TextView[contains(@text,'Select a lot batch no')]")
	@iOSFindBy(xpath = "//UIASTATICTEXT[@text='Select a lot batch no'")
	public MobileElement SELECT_LOT_BATCH_NUMBER_SCREEN_HEADER;
	...
	public MobileElement SERIAL_NUMBER_SCREEN_HEADER;
	...
	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'com.ifsworld.mworkorderapps9:id/search_criteria') and contains(@text,'Search')]")
	...
	@AndroidFindBy(xpath = "//android.widget.ListView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/item2')]")
