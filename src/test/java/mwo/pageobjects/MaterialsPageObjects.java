...
public class MaterialsPageObjects {
	...
	@AndroidFindBy(xpath = "//android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[contains(@text, 'Materials')]")
	...
	@AndroidFindBy(xpath = "//android.widget.ListView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TableLayout/android.widget.TableRow/android.widget.TextView[contains(@text, 'New Planned Part') and contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/debrief_menu_option_name')]")
	public MobileElement NEW_PLANNED_PART_LABEL;
	
	@AndroidFindBy(xpath = "//android.widget.ListView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TableLayout/android.widget.TableRow/android.widget.TextView[contains(@text, 'View Previous') and contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/debrief_menu_option_name')]")
