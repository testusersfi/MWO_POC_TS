...
public class WorkOrdersPageObjects {
  ...
  @AndroidFindBy (xpath = "//android.widget.TextView[contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/work_order_overview_description')]")
