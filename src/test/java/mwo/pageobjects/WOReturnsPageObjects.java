...
public class WOReturnsPageObjects {
	...
	@AndroidFindBy(xpath = "//android.widget.LinearLayout/android.widget.TableLayout/android.widget.TableRow/android.widget.EditText[contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/mobile_work_order_returns__part_no')]")
	...
	@AndroidFindBy(xpath = "//android.widget.LinearLayout/android.widget.TableLayout/android.widget.TableRow/android.widget.TextView[contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/mobile_work_order_returns__serial_no__lbl')]")
	public MobileElement SERIAL_NUMBER_LABEL;
