...
public class WOReportWebViewPageObjects {
	...
	@AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/btnRepNext') and contains(@text, 'Complete')]")
	public MobileElement COMPLETE_BUTTON;
	
	@AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id, 'com.ifsworld.mworkorderapps9:id/btnRepNext') and contains(@text, 'Next')]")
	public MobileElement NEXT_BUTTON;
	
	@AndroidFindBy(xpath = "//android.widget.TextView[contains(@resource-id, 'android:id/message') and contains(@text, 'What do you want to do with this Work Order?')]")
	public MobileElement COMPLETE_WO_ALERT_MESSSAGE;
	
	@AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id, 'android:id/button3') and contains(@text, 'Return Travel')]")
	public MobileElement COMPLETE_WO_ALERT_BUTTON_RETURN_TRAVEL;
	
	@AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id, 'android:id/button2') and contains(@text, 'Return')]")
	public MobileElement COMPLETE_WO_ALERT_BUTTON_RETURN;
	
	@AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id, 'android:id/button1') and contains(@text, 'Keep')]")
	public MobileElement COMPLETE_WO_ALERT_BUTTON_KEEP;
